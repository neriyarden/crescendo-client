...
const PASSWORD_MSG =
	'Password must contain a number, a special character, and a letter, and 8-20 characters'
...
const signUp = Yup.object({
	...
	password: Yup.string()
		...
		.required('Required field'),
	repeat_password: Yup.mixed()
		.oneOf([Yup.ref('password')], "The 2 passwords don't Match")
		.required('Required'),
...
const event = Yup.object({
	...
	ticketseller_url: Yup.string()
		.max(500)
		.required('Ticket Seller URL is required'),
})
