	...
	return (
		<section className='artist-page-hero'>
			<div
				...
				style={{
					backgroundImage: `url(${
						currentServer + artistData.img_url
					})`,
				}}
			></div>
			<div className='artist-hero-content'>
				<ArtistAvatarImg
					imgPath={artistData.img_url}
				...
				<div className='artist-hero-info'>
					...
					<SocialIcons
						iconsData={[
							{
								icon: faSpotify,
								link: artistData.link_to_spotify,
							},
							{
								icon: faYoutube,
								link: artistData.link_to_youtube,
							},
							{
								icon: faFacebook,
								link: artistData.link_to_facebook,
							},
							{
								icon: faInstagram,
								link: artistData.link_to_instagram,
							},
						]}
					/>
				</div>
